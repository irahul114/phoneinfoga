      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <EnvelopeIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-white/40" />
                <input
                  type="email"
                  name="email"
            ...
            {!isLogin && (
              <div>
                ...
                <div className="relative">
                  <BuildingOfficeIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-white/40" />
                  <input
                    type="text"
                    name="company"
            ...
            <div>
              ...
              <div className="relative">
                <LockClosedIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-white/40" />
                <input
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-dark-200 text-white/60">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <motion.button
                ...
                className="w-full inline-flex justify-center py-2 px-4 border border-white/20 rounded-md shadow-sm bg-white/5 text-sm font-medium text-white hover:bg-white/10 transition-all duration-300"
              >
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-white/60 text-sm">Quick setup and instant access to all features</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-white/60 text-sm">99.9% uptime with 24/7 support</p>
          </div>
        </motion.div>
      </div>
    </div>
